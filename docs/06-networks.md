...
##    0.1604938    0.4301558   19.9241419    0.8537307
```
...
## temperature    19.857 0.4186 19.166 16.467 19.159 22.263    0.773
```
...
```
## IGRAPH 8937edb UNWB 851 2679 -- 
## + attr: type (v/l), name (v/c), weight (e/n)
## + edges from 8937edb (vertex names):
