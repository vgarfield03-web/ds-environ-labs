...
holiday_df <- rast_to_df(holiday_clean)
beachie_df <- rast_to_df(beachie_clean)
terwilliger_df <- rast_to_df(terwilliger_clean)
...
beachie_df$fire <- "beachie fire"
terwilliger_df$fire <- "terwilliger fire"
